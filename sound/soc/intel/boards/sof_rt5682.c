...
static int sof_audio_probe(struct platform_device *pdev)
{
	...
	if (sof_rt5682_quirk & SOF_MAX98373_SPEAKER_AMP_PRESENT)
		...
		if (sof_rt5682_quirk & SOF_MAX98390_TWEETER_SPEAKER_PRESENT)
			max_98390_set_codec_conf(&sof_audio_card_rt5682, ARRAY_SIZE(max_98390_4spk_components));
		else
			max_98390_set_codec_conf(&sof_audio_card_rt5682, ARRAY_SIZE(max_98390_components));
	}
