...
static const struct snd_soc_acpi_adr_device rt1320_2_group3_adr[] = {
	{
		.adr = 0x000230025D132001ull,
		.num_endpoints = 1,
		.endpoints = &spk_l_endpoint,
...
static const struct snd_soc_acpi_adr_device rt1320_3_group3_adr[] = {
	{
		.adr = 0x000330025D132001ull,
		.num_endpoints = 1,
		.endpoints = &spk_r_endpoint,
...
static const struct snd_soc_acpi_link_adr ptl_rt722_l0_rt1320_l23[] = {
	...
	{
		.mask = BIT(2),
		.num_adr = ARRAY_SIZE(rt1320_2_group3_adr),
		.adr_d = rt1320_2_group3_adr,
	},
	{
		.mask = BIT(3),
		.num_adr = ARRAY_SIZE(rt1320_3_group3_adr),
		.adr_d = rt1320_3_group3_adr,
	},
	{}
};
